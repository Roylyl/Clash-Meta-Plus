...
class StatusProvider : ContentProvider() {
    ...
    companion object {
        ...
        // Persist user intent independently of the current process. A system kill must not
        // erase recovery state, while explicit stop, VPN revocation and runtime errors do.
