...
class LargeActionCard @JvmOverloads constructor(
    ...
    init {
        ...
        strokeWidth = context.resources.displayMetrics.density.toInt().coerceAtLeast(1)
        strokeColor = context.resolveThemedColor(R.attr.glassBorder)
        setCardBackgroundColor(context.resolveThemedColor(R.attr.glassSurface))
    }
}
