...
class ExternalControlActivity : Activity(), CoroutineScope by MainScope() {
    ...
    private fun isClashRunning(): Boolean {
        // A newer explicit Start may supersede a Stop whose runtime cleanup is pending.
        return StatusProvider.shouldStartClashOnBoot && StatusClient(this).currentProfile() != null
    }
